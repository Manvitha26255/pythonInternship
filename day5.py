...
acc = InstagramAccount("insta", "1234")
acc.add_private_reel("trip reel")
acc.add_private_reel("Party reel")

acc.add_archived_reel("Old Dance Video")
acc.add_archived_reel("School Memories")

acc.display_private_reels(True)
acc.display_private_reels(False)

acc.display_archived_reels("1234")
acc.display_archived_reels("0234")

data = acc.get_archived_reels("1234")
